...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        tScale = a.getFloat(R.styleable.RoundedImageView_scaleToParent,1);
        a.recycle();
    }
    ...
    private void drawCircleBorder(Canvas canvas, int radius, int color) {
        ...
        canvas.drawCircle(defaultWidth / 2, defaultHeight / 2, radius, bgPaint);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec){
        ...
        }else if(tScale > 0 && tScale < 1){
            DisplayMetrics metrics = new DisplayMetrics();
            WindowManager manager = (WindowManager)getContext().getSystemService(Context.WINDOW_SERVICE);
            manager.getDefaultDisplay().getMetrics(metrics);
            int width = (int)(metrics.widthPixels * tScale);
            int height = (int)(metrics.heightPixels * tScale);
