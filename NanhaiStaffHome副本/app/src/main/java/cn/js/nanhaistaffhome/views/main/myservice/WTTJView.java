 ...
 * 文体推介
 */
public class WTTJView extends RefreshListView{

    private List<News> newsList = new ArrayList<>();
    private NewsAdapter adapter;

    public WTTJView(Context context){
        super(context);

        init(context);
    }

    public WTTJView(Context context,AttributeSet attrs){
        super(context, attrs);
    ...
    private void init(Context context){
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ActivityManager.toNewsDetailActivity(getContext(), newsList.get(i - 1).getContentId(),"文体推介");
            }
        });
    ...
    private void getServiceList(String time,final int type){
        HttpClient.getNewsByTime(98, 10, time, type, new OnHttpRequestListener() {
            @Override
