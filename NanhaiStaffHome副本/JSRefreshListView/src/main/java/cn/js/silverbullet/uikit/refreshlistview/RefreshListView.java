...
public class RefreshListView extends ListView implements OnClickListener,AbsListView.OnScrollListener{
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem, int visibleItemCount, int totalItemCount) {
		...
		mEndItemIndex = mFirstItemIndex + visibleItemCount;
		if(mEndItemIndex>=totalItemCount)
		{
			mEndItemIndex = totalItemCount - 1;
		}
	}
